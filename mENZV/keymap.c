...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(2,KC_GRAVE), MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_S),KC_D,           MT(MOD_LCTL, KC_F),KC_G,                                           KC_H,           MT(MOD_RCTL, KC_J),KC_K,           MT(MOD_RALT, KC_L),MT(MOD_RGUI, KC_SCLN),KC_QUOTE,       
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        KC_LBRC,        KC_RBRC,        KC_TILD,                                        KC_UNDS,        KC_1,           KC_2,           KC_3,           KC_TRANSPARENT, KC_PERC,        
                                                    KC_BSPC,        KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_0)
  ),
  [2] = LAYOUT_voyager(
