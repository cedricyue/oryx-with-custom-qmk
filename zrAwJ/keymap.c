...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_SCRL,        TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    KC_CAPS,                                        KC_MEDIA_PREV_TRACK,TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    KC_TRANSPARENT, 
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_AUDIO_VOL_UP,                                KC_MEDIA_NEXT_TRACK,KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_ESCAPE,      
    LT(2, KC_GRAVE),MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LSFT, KC_D),MT(MOD_LCTL, KC_F),KC_G,           KC_AUDIO_VOL_DOWN,                                                                TD(DANCE_10),   KC_H,           MT(MOD_RCTL, KC_J),MT(MOD_RSFT, KC_K),MT(MOD_RALT, KC_L),MT(MOD_RGUI, KC_SCLN),KC_QUOTE,       
...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[0].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_1)); break;
...
void dance_1_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[1].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_2)); break;
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[2].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_3)); break;
...
void dance_3_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[3].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_4)); break;
...
void dance_4_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_5)); break;
...
void dance_4_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LALT(KC_5)); break;
...
void dance_5_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_6)); break;
...
void dance_5_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[5].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LALT(KC_6)); break;
...
void dance_6_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[6].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_7)); break;
...
void dance_7_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_8)); break;
...
void dance_7_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LALT(KC_8)); break;
...
void dance_8_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[8].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_9)); break;
...
void dance_8_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[8].step) {
        ...
        case DOUBLE_TAP: unregister_code16(LALT(KC_9)); break;
...
void dance_9_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[9].step) {
        ...
        case DOUBLE_TAP: register_code16(LALT(KC_0)); break;
