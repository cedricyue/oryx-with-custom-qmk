...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_GRAVE, MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_S),LT(1, KC_D),MT(MOD_LCTL, KC_F),KC_G,           KC_AUDIO_VOL_DOWN,                                                                TD(DANCE_0),    KC_H,           MT(MOD_RCTL, KC_J),LT(1, KC_K),MT(MOD_RALT, KC_L),MT(MOD_RGUI, KC_SCLN),KC_QUOTE,       
